export default function LessonPage({ 
  ...
  const lessonData = {
    ...
    3: {
      ...
      content: {
        dialogue: [
          { speaker: "A", czech: "Ahoj! Jak se máš?", english: "Hi! How are you?" },
          { speaker: "B", czech: "Ahoj! Mám se dobře.", english: "Hi! I'm fine." },
        ]
      }
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {lesson.type === "grammar" && (
          <div className="bg-white rounded-xl shadow-lg p-6">
            <h2 className="text-xl font-bold text-gray-800 mb-4">Text & Audio</h2>
