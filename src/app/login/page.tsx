...
function LoginForm() {
  ...
  const initialMode =
    (searchParams.get("mode") ?? "user") === "admin" ? "admin" : "user";
  ...
  return (
    <Card hover={false} className="max-w-md mx-auto w-full shadow-md border border-slate-200/80">
      <div className="mb-4">
      ...
      <form onSubmit={onSubmit} className="space-y-4">
        ...
        <div className={mode === "admin" ? "opacity-60 pointer-events-none" : ""}>
