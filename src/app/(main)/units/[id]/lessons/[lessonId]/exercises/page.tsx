...
export default function ExercisesPage() {
  ...
  }, [completed, lesson]); // eslint-disable-line react-hooks/exhaustive-deps -- omit completeLesson to avoid loops
      ...
      {showSuccess && (
        <div className="bg-green-50 border-2 border-green-200 rounded-xl p-6 text-center">
          ...
          <p className="text-green-700 mb-4">
            {`Great job! You have completed all exercises in this lesson.`}
          </p>
          {completingLesson ? (
